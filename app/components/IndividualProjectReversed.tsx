  ...
  return (
    <div className="my-32 flex justify-center items-center w-full">
      ...
      <div className="w-1/2 pl-24">
        ...
        <p className="font-mono mt-12 text-right">
        ...
        <div className="flex gap-6 justify-end items-center text-2xl font-mono my-4">
          <p>stack1</p>
          <p>stack2</p>
          <p>stack3</p>
          <p>stack4</p>
        </div>
        <div className="flex my-4 gap-6 justify-end items-center text-2xl font-mono">
          <a>Github</a>
          <a>Test</a>
        </div>
      </div>
